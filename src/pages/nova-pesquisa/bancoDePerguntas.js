...
const clima = [
  { tipo: 'nota', enunciado: 'De 0 a 5, o quanto você recomendaria {p} como um bom lugar pra trabalhar?', pontaEsquerda: 'Não recomendaria', pontaDireita: 'Recomendaria' },
  ...
  { tipo: 'nota', enunciado: 'Como você avalia a colaboração entre as pessoas de {p}?', pontaEsquerda: 'Pouco colaborativo', pontaDireita: 'Muito colaborativo' },
  ...
  { tipo: 'nota', enunciado: 'Você sente que os prazos dos projetos são realistas?', pontaEsquerda: 'Irrealistas', pontaDireita: 'Realistas' },
  ...
  { tipo: 'nota', enunciado: 'O quanto você se sente parte das decisões que afetam seu trabalho?', pontaEsquerda: 'De fora', pontaDireita: 'Parte das decisões' },
  ...
  { tipo: 'nota', enunciado: 'O quanto você entende como seu trabalho contribui para os objetivos da empresa?', pontaEsquerda: 'Não entendo', pontaDireita: 'Entendo bem' },
  ...
  { tipo: 'nota', enunciado: 'Como você avalia seu equilíbrio entre vida pessoal e trabalho?', pontaEsquerda: 'Desequilibrado', pontaDireita: 'Equilibrado' },
]

const feedback = [
  { tipo: 'nota', enunciado: 'De 0 a 5, o quanto você recomendaria esta edição para outras pessoas de {p}?', pontaEsquerda: 'Não recomendaria', pontaDireita: 'Recomendaria' },
  ...
  { tipo: 'nota', enunciado: 'O conteúdo apresentado atendeu suas expectativas?', pontaEsquerda: 'Ficou abaixo', pontaDireita: 'Superou' },
  { tipo: 'escolhaUnica', enunciado: 'Como você avalia a organização e a logística?', opcoes: ['Muito boa', 'Boa', 'Regular', 'Ruim'] },
  { tipo: 'nota', enunciado: 'O quanto o que você viu é aplicável no seu dia a dia?', pontaEsquerda: 'Nada aplicável', pontaDireita: 'Muito aplicável' },
  ...
  { tipo: 'nota', enunciado: 'O quanto você se sentiu à vontade para participar?', pontaEsquerda: 'Nada à vontade', pontaDireita: 'Muito à vontade' },
  ...
  { tipo: 'nota', enunciado: 'O quanto o tempo para perguntas foi adequado?', pontaEsquerda: 'Insuficiente', pontaDireita: 'Adequado' },
...
const solicitacao = [
  { tipo: 'nota', enunciado: 'De 0 a 5, o quanto os processos internos hoje atendem as necessidades de {p}?', pontaEsquerda: 'Não atendem', pontaDireita: 'Atendem bem' },
  ...
  { tipo: 'nota', enunciado: 'O quanto é claro para você por onde abrir cada tipo de pedido?', pontaEsquerda: 'Nada claro', pontaDireita: 'Muito claro' },
  ...
  { tipo: 'nota', enunciado: 'O quanto a documentação interna te ajuda a resolver as coisas sozinho?', pontaEsquerda: 'Não ajuda', pontaDireita: 'Ajuda muito' },
  ...
  { tipo: 'nota', enunciado: 'O quanto os prazos combinados para as solicitações são cumpridos?', pontaEsquerda: 'Raramente', pontaDireita: 'Quase sempre' },
  ...
  { tipo: 'nota', enunciado: 'O quanto você se sente apoiado pelas áreas de suporte?', pontaEsquerda: 'Desamparado', pontaDireita: 'Bem apoiado' },
]

const desligamento = [
  { tipo: 'nota', enunciado: 'De 0 a 5, o quanto você recomendaria a empresa para alguém de {p}?', pontaEsquerda: 'Não recomendaria', pontaDireita: 'Recomendaria' },
  ...
  { tipo: 'nota', enunciado: 'O quanto você se sentiu apoiado pela sua liderança direta?', pontaEsquerda: 'Sem apoio', pontaDireita: 'Muito apoiado' },
  { tipo: 'escolhaUnica', enunciado: 'Como foi seu processo de integração quando entrou?', opcoes: ['Muito bom', 'Bom', 'Regular', 'Ruim'] },
  { tipo: 'nota', enunciado: 'O quanto suas atividades correspondiam ao que foi combinado na contratação?', pontaEsquerda: 'Nada parecido', pontaDireita: 'Exatamente' },
  ...
  { tipo: 'nota', enunciado: 'O quanto sua remuneração correspondia à sua entrega?', pontaEsquerda: 'Muito abaixo', pontaDireita: 'Compatível' },
  ...
  { tipo: 'nota', enunciado: 'O quanto você teve oportunidades de aprender e crescer aqui?', pontaEsquerda: 'Nenhuma', pontaDireita: 'Muitas' },
